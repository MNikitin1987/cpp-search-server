...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status_req) const {
        return FindTopDocuments(raw_query, [status_req](int document_id, DocumentStatus status, int rating) { return status == status_req; });
